// Comments: Question 1: Yes, Question 2: Yes, Question 3: No, mine is not the same, but I do understand it.
...
// Class: CSCI 121
// Project: Project 06
// This project will help the students to reinforce the knowledge from Chapter 6 of the textbook.

// 1. Understand and apply top-down design concept.
// 2. Implement the functions according to specified requirements.
// 3. Understand and apply file output stream to output information to file.
