//Program to demonstart a function calling another function.
#include <iostream>
...
//so that after the functionc all n1 <= n2.

void giveResults(int output1, int outpu2);
...
//Uses iostream;
void getInput(int& input1, int& intput2)
{
    using namespace std;
